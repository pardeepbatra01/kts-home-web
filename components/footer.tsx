      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-6 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="mailto:support@ktshome.ca" className="text-blue-100/80 hover:text-white text-sm">Email</Link></li>
              <li><Link href="tel:+18554587669" className="text-blue-100/80 hover:text-white text-sm">Phone</Link></li>
            </ul>
          </div>
